...
class CodeCraftHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def ai_gemini_process(self, api_key, action, language, code, error, prompt):
        sys_prompt = (
            ...
            "Never refer to yourself as Gemini or mention Google Gemini; refer to yourself as the Codédex AI Agent or Cloud AI. "
        ...
        return {
            ...
            "summary": "Generated by Codédex AI Cloud Intelligence.",
